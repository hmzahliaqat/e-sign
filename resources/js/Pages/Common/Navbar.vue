    ...
    <header class="bg-white shadow-md">
        <div class="mx-auto px-2 sm:px-4 lg:divide-y lg:divide-gray-200 lg:px-8">
            <div class="relative flex h-16 justify-between">
                <div class="relative z-10 flex px-2 lg:px-0">
                    <div class="flex flex-shrink-0 items-center">
                        <img class="h-14 py-1 w-auto" src="../../../../public/images.png" alt="Your Company" />
                    </div>
                </div>
                ...
                <div class="hidden lg:relative lg:z-10 lg:ml-4 lg:flex lg:items-center">
                    ...
                    <div class="relative ml-4 flex-shrink-0">
                        <div class="flex items-center">
                            <span class="mr-3 text-md font-medium text-gray-500">{{ company?.company_name }}</span>
                            <button @click="toggleDropdown" type="button"
                                class="relative cursor-pointer flex rounded-full bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
            ...
            <nav class="hidden lg:flex lg:space-x-8 lg:py-4 lg:justify-center w-full" aria-label="Global">
                ...
                <router-link to="/company/documents"
                    class="bg-gray-100 text-gray-900 inline-flex items-center rounded-md py-2 px-3 text-sm font-medium"
                    aria-current="page">
                    Documents
        ...
        <nav v-if="dropdown" class="lg:hidden" aria-label="Global" id="mobile-menu">
            <div class="space-y-1 px-2 pb-3 pt-2">
                <!-- Current: "bg-gray-100 text-gray-900", Default: "text-gray-900 hover:bg-gray-50 hover:text-gray-900" -->
                <a href="#" class="bg-gray-100 text-gray-900 block rounded-md py-2 px-3 text-base font-medium"
                    aria-current="page">Dashboard</a>
                <a href="#"
                    class="text-gray-900 hover:bg-gray-50 hover:text-gray-900 block rounded-md py-2 px-3 text-base font-medium">Documents</a>
